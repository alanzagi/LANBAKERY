<x-layout :title="$title">
    @section('page')
        ...
        <main class="bg-yellow-300 py-12 flex items-center justify-center font-poppins">
            <div class="px-4 w-full space-y-6 md:px-20">
                <section
                    class="grid grid-cols-1 bg-white px-4 py-4 rounded-lg shadow-md shadow-gray-800 gap-y-8 gap-x-4 md:grid-cols-2">
                    ...
                    <ul class="text-gray-700 pb-8">
                        <li class="text-center space-y-2">
                            ...
                            <p class="text-sm md:px-20">Jl. Bintara, Sekip Lama, Kec. Singkawang Tengah, Kota Singkawang,
                                Kalimantan
                                Barat 79113</p>
                        </li>
                        <li class="text-center space-y-2">
                ...
                <section
                    class="grid grid-cols-1 bg-white px-4 py-4 rounded-lg shadow-md shadow-gray-800 gap-y-8 gap-x-4 md:grid-cols-2">
                    <div class="flex items-center justify-center col-start-1">
                        <iframe class="w-full h-96"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.306871157643!2d108.99156647403575!3d0.9174173628151688!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31e3720bf760c1af%3A0x27d34f843e1c8e0e!2sJl.%20Perwira%2C%20Sekip%20Lama%2C%20Kec.%20Singkawang%20Tengah%2C%20Kota%20Singkawang%2C%20Kalimantan%20Barat%2079113!5e0!3m2!1sid!2sid!4v1739162714998!5m2!1sid!2sid"
                            width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>

                    <ul class="text-gray-700 pb-8 col-start-2">
                        <li class="text-center space-y-2">
                            <div class="flex items-center justify-center w-16 h-16 mx-auto -mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg"viewBox="0 -960 960 960"
                                    class="fill-current text-yellow-300 w-10 h-10">
                            ...
                            <h2 class="text-xl font-semibold">Alamat</h2>
                            <p class="text-sm md:px-20">Sekip Lama, Kec. Singkawang Tengah, Kota Singkawang, Kalimantan
                                Barat 79113
                            </p>
                        </li>
                        <li class="text-center space-y-2">
