    ...
    <div class="absolute top-0 left-0 w-full bg-yellow-300 border-gray-200 font-poppins z-10">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full lg:block lg:w-auto" id="navbar-default">
                <ul
                    class="font-medium flex flex-col p-4 lg:p-0 mt-4 border-2 border-gray-800 rounded-xl bg-gray-200 lg:flex-row lg:space-x-2 lg:mt-0 lg:border-0 lg:bg-yellow-300">
                    <li>
